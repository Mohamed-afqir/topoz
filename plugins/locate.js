    ...
    var o = function(i, o, t) {
        ...
        e = t.extend({
            initialize: function(t, i, o) {
                h.Util.setOptions(this, o), this._latlng = t, this._heading = i, this.createIcon()
            },
        ...
        n = h.Control.extend({
            options: {
                ...
                createButtonCallback: function(t, i) {
                    var o = h.DomUtil.create("a", "leaflet-bar-part leaflet-bar-part-single", t);
                    return o.title = i.strings.title, {
                        link: o,
                        icon: h.DomUtil.create(i.iconElementTag, i.icon, o)
                    }
                },
                ...
                strings: {
                    ...
                    metersUnit: "meters",
                    feetUnit: "feet",
                    popup: "Vous êtes à {distance}m de ce point",
                    outsideMapBoundsMsg: "You semblez être en dehors des limites de la carte"
                },
                locateOptions: {
                    maxZoom: 1 / 0,
                    watch: !0,
            ...
            _drawMarker: function() {
                ...
                this.options.showPopup && a && this._marker && this._marker.bindPopup(h.Util.template(a, {
                    distance: t,
                    unit: i
                }))._popup.setLatLng(s), this.options.showPopup && a && this._compass && this._compass.bindPopup(h.Util.template(a, {
                    distance: t,
                    unit: i
                }))._popup.setLatLng(s)
            },
            ...
            _setCompassHeading: function(t) {
                !isNaN(parseFloat(t)) && isFinite(t) ? (t = Math.round(t), this._compassHeading = t, h.Util.requestAnimFrame(this._drawCompass, this)) : this._compassHeading = null
            },
            ...
            _cleanClasses: function() {
                h.DomUtil.removeClass(this._container, "requesting"), h.DomUtil.removeClass(this._container, "active"), h.DomUtil.removeClass(this._container, "following"), s(this._icon, this.options.iconLoading), i(this._icon, this.options.icon)
            },
            _resetVariables: function() {
                this._active = !1, this._justClicked = !1, this._userPanned = !1, this._userZoomed = !1
            }
        });
    return h.control.locate = function(t) {
